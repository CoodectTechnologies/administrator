    ...
    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
        ...
        <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('{{ asset('assets/admin/media/misc/pattern-1.jpg') }}')">
            ...
            <h3 class="text-white fw-bold px-9 mt-10 mb-6">Notificaciones
                @if (count($notifications))
                    <span class="fs-8 opacity-75 ps-3">{{ count($notifications) }} sin leer</span>
                @endif
            </h3>
            <!--end::Title-->
            <!--begin::Tabs-->
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="kt_topbar_notifications_1" role="tabpanel">
                ...
                <div class="py-3 text-center border-top">
                    <a href="{{ route('admin.user.show', ['user' => auth()->user(), 'submodule' => 'notifications']) }}" class="btn btn-color-gray-600 btn-active-color-primary">Ver todo
