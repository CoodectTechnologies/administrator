    ...
    <div class="card-body p-lg-20 pb-lg-0">
        ...
        <div class="d-flex flex-column flex-xl-row">
            ...
            <div class="flex-column flex-lg-row-auto w-100 w-xl-300px mb-10">
                <!--begin::Recent posts-->
                <div class="m-0">
                    <h4 class="text-black mb-7">Proyectos recientes</h4>
                ...
                <!--end::Recent posts-->
                <div class="mb-7">
                    <h4 class="text-black mb-2">Cliente</h4>
                ...
                <div class="mb-7">
                    <h4 class="text-black mb-2">Servicio</h4>
                    <p>{{ $project->service ? $project->service->name : 'N/A' }}</p>
                </div>
                <div class="mb-7">
                    <h4 class="text-black mb-2">Fecha</h4>
                    <p>{{ $project->date }}</p>
                </div>
            </div>
            <!--end::Sidebar-->
