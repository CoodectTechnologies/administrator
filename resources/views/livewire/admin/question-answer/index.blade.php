    ...
    <div class="card">
        ...
        <div class="card-body p-10 p-lg-15">
            ...
            <div class="mb-13">
                ...
                <div class="mb-15">
                    <!--begin::Title-->
                    <h4 class="fs-2x text-gray-800 w-bolder mb-6">Preguntas frecuentes</h4>
                    <!--end::Title-->
                    <!--begin::Text-->
                    <p class="fw-bold fs-4 text-gray-600 mb-2">Gestionarás las preguntas más frecuentes de los clientes proporcionando las respuestas, de forma que la información está siempre disponible para ellos.</p>
                    <!--end::Text-->
                </div>
                <!--end::Intro-->
                <!--begin::Row-->
