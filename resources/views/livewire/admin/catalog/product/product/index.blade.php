            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                ...
                <div class="dropdown">
                    <a class="btn btn-light-primary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <!--end::Svg Icon-->
                    Acciones <span wire:loading wire:target="exportProducts" class="spinner-border spinner-border-sm align-middle ms-2"></span>
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a href="{{ route('admin.catalog.product.create') }}" class="dropdown-item">Nuevo producto</a></li>
                        <li><a wire:click="exportProducts" wire:loading.attr="disabled" wire:target="exportProducts" href="#" class="dropdown-item">Exportar productos</a></li>
                        <li><a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_import" class="dropdown-item">Importar productos</a></li>
                    </ul>
                </div>
                <!--begin::Button-->
            </div>
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="text-end min-w-70px">Cantidad</th>
                            <th class="text-end min-w-70px">Comentarios</th>
                            <th class="text-end min-w-70px">Vistas</th>
