        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <!--end::Svg Icon-->
                    <input wire:model="search" type="search" class="form-control form-control-solid w-250px ps-14" placeholder="Buscar persona" />
                </div>
                <!--end::Search-->
            </div>
            <!--begin::Card title-->
                    ...
                    @foreach ($team as $person)
                        ...
                        <div class="col mb-9">
                            <div class="text-center">
                                ...
                                <!--end::Person-->
                                <a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_update_team_{{ $person->id }}" class="btn btn-light-success btn-shadow">Editar</a>
                                <a href="#" onclick="event.preventDefault(); confirmDestroyTeam({{ $person->id }})" class="btn btn-light-danger btn-shadow ms-2">Elimnar</a>
                            </div>
