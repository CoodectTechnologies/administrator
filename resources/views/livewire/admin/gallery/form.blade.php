    ...
    <form class="form" wire:submit.prevent="{{ $method }}">
        ...
        <div class="mb-7">
            ...
            <div class="form-group row">
                <!--begin::Label-->
                <label class="col-lg-2 col-form-label text-lg-right required">Imagenes </label>
                <!--end::Label-->
                <!--begin::Col-->
                <div class="col-lg-10">
                    <!--begin::File-->
                    ...
                    <!--end::File-->
                    <!--begin::Hint-->
                    <span class="form-text text-muted">Procura subir no más de 10 imagenes a la vez.</span>
                    <!--end::Hint-->
                </div>
                <!--end::Col-->
