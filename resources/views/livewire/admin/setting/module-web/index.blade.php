    ...
    <div class="card card-flush">
        ...
        <div class="card-header mt-6">
            ...
            <div class="card-toolbar">
                @include('admin.setting.module-web.create')
            </div>
            <!--end::Card toolbar-->
        </div>
        <!--end::Card header-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-100px">Banners</th>
                            <th class="min-w-100px">Galería</th>
                    ...
                    <tbody class="fw-bold text-gray-600">
                        ...
                        <tr>
                            <td>{{ $moduleWeb->name }}</td>
                            <td>{{ count($moduleWeb->banners) }}</td>
                            <td>{{ count($moduleWeb->galleries) }}</td>
                            <td>{{ count($moduleWeb->videos) }}</td>
                            <td>
                                @include('admin.setting.module-web.edit')
                                @include('admin.setting.module-web.delete')
                            </td>
                            <!--end::Action=-->
                        </tr>
                        @endforeach
