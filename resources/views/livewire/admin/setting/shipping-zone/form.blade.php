                ...
                <div class="card-body">
                    <form class="form" wire:submit.prevent="{{ $method }}">
                        ...
                        <div class="fv-row mb-7">
                            <div>
                                <label class="fs-6 fw-bold form-label mb-2">
                                    <span class="required">Estados</span>
                                </label>
                                <select wire:model.defer="shippingZoneStatesArray" class="shippingZonestatesArray form-select form-select-solid @error('shippingZoneStatesArray') 'invalid-feedback' @enderror" data-control="select2" data-placeholder="Selecciona los estados" data-allow-clear="true" multiple="multiple">
