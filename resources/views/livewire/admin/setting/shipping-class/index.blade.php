    ...
    <div class="card card-flush">
        ...
        <div class="card-header mt-6">
            ...
            <div class="card-toolbar">
                @include('admin.setting.shipping-class.create')
            </div>
            <!--end::Card toolbar-->
        </div>
        <!--end::Card header-->
            ...
            <div class="table-responsive">
                <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="">
                    ...
                    <tbody class="fw-bold text-gray-600">
                        ...
                        <tr>
                            <td>{{ $shippingClass->name }}</td>
                            <td>{{ $shippingClass->description }}</td>
                            <td>{{ count($shippingClass->products) }}</td>
                            <td>
                                @include('admin.setting.shipping-class.edit')
                                @include('admin.setting.shipping-class.delete')
                            </td>
                            <!--end::Action=-->
                        </tr>
                        @endforeach
