        ...
        <div wire:ignore.self class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_user" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_role_header" data-kt-scroll-wrappers="#kt_modal_update_user" data-kt-scroll-offset="300px">
            ...
            <div id="kt_user_form_profile_general" class="collapse show">
                ...
                <div class="fv-row mb-7">
                    ...
                    <input required wire:model.defer="user.name" class="form-control form-control-solid @error('user.name') 'invalid-feedback' @enderror" placeholder="Ej: Nombre completo" name="" />
                ...
                <div class="fv-row mb-7">
                    ...
                    <input type="email" required wire:model.defer="user.email" class="form-control form-control-solid @error('user.email') 'invalid-feedback' @enderror" placeholder="Ej: Nombre completo" name="" />
            ...
            <!--begin::Details toggle-->
            <div class="d-flex flex-stack fs-4 py-3">
                <div class="fw-bolder rotate collapsible" data-bs-toggle="collapse" href="#kt_user_form_profile_roles" role="button" aria-expanded="false" aria-controls="kt_user_form_profile_roles">Roles
                <span class="ms-2 rotate-180">
                    <!--begin::Svg Icon | path: icons/duotune/arrows/arr072.svg-->
                    <span class="svg-icon svg-icon-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <!--begin::Details toggle-->
            <div class="d-flex flex-stack fs-4 py-3">
                <div class="fw-bolder rotate collapsible" data-bs-toggle="collapse" href="#kt_user_form_profile_password" role="button" aria-expanded="false" aria-controls="kt_user_form_profile_password">Contraseña
                <span class="ms-2 rotate-180">
                    <!--begin::Svg Icon | path: icons/duotune/arrows/arr072.svg-->
                    <span class="svg-icon svg-icon-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <div id="kt_user_form_profile_password" class="collapse show">
                ...
                <div class="notice d-flex bg-light-info rounded border-info border border-dashed mb-9 p-6">
                    ...
                    <div class="d-flex flex-stack flex-grow-1">
                        ...
                        <div class="fw-bold">
                            ...
                            <strong class="me-1">Información!</strong> Al dejar los campos en blanco, no se modificara la información de contraseña.</div>
                        </div>
                        <!--end::Content-->
                    </div>
                    <!--end::Wrapper-->
                ...
                <div class="fv-row mb-7">
                    ...
                    <input type="password" wire:model.defer="password" class="form-control form-control-solid @error('password') 'invalid-feedback' @enderror" placeholder="Nueva contraseña" name="" />
                ...
                <div class="fv-row mb-7">
                    ...
                    <input type="password" wire:model.defer="password_confirmation" class="form-control form-control-solid @error('password_confirmation') 'invalid-feedback' @enderror" placeholder="Confirma tu contraseña" name="" />
