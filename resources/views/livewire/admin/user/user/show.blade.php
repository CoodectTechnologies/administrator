                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-center flex-column py-5">
                        ...
                        @if (Route::has('admin.order.index'))
                            <!--begin::Info-->
                            <!--begin::Info heading-->
                            <div class="fw-bolder mb-3">Ordenes
                            ...
                            <div class="d-flex flex-wrap flex-center">
                                ...
                                <div class="border border-gray-300 border-dashed rounded py-3 px-3 mb-3">
                                    ...
                                    <div class="fw-bold text-muted">Ordenes</div>
                                </div>
                                <!--end::Stats-->
                                <!--begin::Stats-->
                                <div class="border border-gray-300 border-dashed rounded py-3 px-3 mx-4 mb-3">
                                    ...
                                    <div class="fw-bold text-muted">Ingresos</div>
                                </div>
                                <!--end::Stats-->
                            </div>
                            <!--end::Info-->
                    ...
                    <div class="d-flex flex-stack fs-4 py-3">
                        <div class="fw-bolder rotate collapsible" data-bs-toggle="collapse" href="#kt_user_view_details" role="button" aria-expanded="false" aria-controls="kt_user_view_details">Detalles
                    ...
                    <div id="kt_user_view_details" class="collapse show">
                        <div class="pb-5 fs-6">
                            <!--begin::Details item-->
                            <div class="fw-bolder mt-5">Cuenta ID</div>
                            ...
                            <!--begin::Details item-->
                            <!--begin::Details item-->
                            <div class="fw-bolder mt-5">Creado</div>
