    ...
    <form class="form" wire:submit.prevent="{{ $method }}">
        <div wire:ignore.self class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_shipping_address_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_shipping_address_header" data-kt-scroll-wrappers="#kt_modal_add_shipping_address_scroll" data-kt-scroll-offset="300px">
                ...
                <div class="d-flex">
                    ...
                    <div class="form-check form-check-custom form-check-solid">
                        ...
                        <label class="form-check-label" for="kt_shipping_address_default_option_{{ $user->id }}">
                            <div class="fw-bolder text-gray-800">Definir como default</div>
                        </label>
                        <!--end::Label-->
                    </div>
                    <!--end::Radio-->
            ...
            <div class="fv-row mb-7">
                ...
                <input required wire:model.defer="shippingAddress.name" class="form-control form-control-solid @error('shippingAddress.name') 'invalid-feedback' @enderror" placeholder="Nombre completo del cliente" />
            ...
            <div class="fv-row mb-7">
                ...
                <input type="tel" required wire:model.defer="shippingAddress.phone" class="form-control form-control-solid @error('shippingAddress.phone') 'invalid-feedback' @enderror" placeholder="Ej: 33xxxxxxxx" />
            ...
            <div class="fv-row mb-7">
                ...
                <input required wire:model.defer="shippingAddress.municipality" class="form-control form-control-solid @error('shippingAddress.municipality') 'invalid-feedback' @enderror" placeholder="Ej: Guadalajara" />
            ...
            <div class="fv-row mb-7">
                ...
                <input required wire:model.defer="shippingAddress.zip_code" class="form-control form-control-solid @error('shippingAddress.zip_code') 'invalid-feedback' @enderror" placeholder="" />
            ...
            <div class="row">
                <div class="fv-row col-6 mb-7">
                    <label class="fs-6 fw-bolder form-label mb-2">
                        <span class="required">Número interior</span>
                    </label>
                    <input type="number" required wire:model.defer="shippingAddress.street_number_int" class="form-control form-control-solid @error('shippingAddress.street_number_int') 'invalid-feedback' @enderror" placeholder="" />
                    @error('shippingAddress.street_number_int') <small  class="form-text text-danger" role="alert">{{ $message }}</small> @enderror
                </div>
                <div class="fv-row col-6 mb-7">
                    <label class="fs-6 fw-bolder form-label mb-2">
                        <span class="">Número exterior</span>
                    </label>
                    <input type="number" wire:model.defer="shippingAddress.street_number_ext" class="form-control form-control-solid @error('shippingAddress.street_number_ext') 'invalid-feedback' @enderror" placeholder="" />
