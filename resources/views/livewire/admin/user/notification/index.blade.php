<div>
    ...
    <div class="card card-xl-stretch mb-xl-8">
        ...
        <div class="card-header border-0">
            <h3 class="card-title fw-bolder text-dark">Notificaciones</h3>
            <div class="card-toolbar">
                ...
                <div wire:ignore.self class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
                    ...
                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                        <a href="#" wire:click="markAllAsRead" class="menu-link px-3">Limpiar notificaciones</a>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                        <a href="#" wire:click="$set('filterReadAt', 'Sin leer')" class="menu-link px-3">Sin leer</a>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                        <a href="#" wire:click="$set('filterReadAt', 'Leidas')" class="menu-link px-3">Ver leidas</a>
                    </div>
                    <!--end::Menu item-->
                </div>
                <!--end::Menu 3-->
        ...
        <div class="card-body pt-0">
            @forelse ($notifications as $notification)
                ...
                <!--end::Item-->
            @empty
                <p class="text-gray-400 text-center">Sin novedades</p>
            @endforelse
            {{ $notifications->links() }}
        </div>
        <!--end::Body-->
