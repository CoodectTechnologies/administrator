                                ...
                                <div class="notice d-flex bg-light-info rounded border-info border border-dashed mb-9 p-6">
                                    ...
                                    <div class="d-flex flex-stack flex-grow-1">
                                        ...
                                        <div class="fw-bold">
                                            ...
                                            <strong class="me-1">Información: </strong> Los permisos directos ayudarán al usuario a tener privilegio sobre el permiso que se le autorize, sin importar que no tenga el rol necesario.</div>
                                        </div>
                                        <!--end::Content-->
                                    </div>
                                    <!--end::Wrapper-->
