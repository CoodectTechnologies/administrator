        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <!--end::Svg Icon-->
                    <input wire:model="search" type="search" class="form-control form-control-solid w-250px ps-14" placeholder="Buscar post" />
                </div>
                <!--end::Search-->
            </div>
            <!--begin::Card title-->
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card-xl-stretch me-md-6">
                            ...
                            <div class="text-center">
                                <a href="{{ route('admin.blog.post.edit', $post) }}" class="btn btn-light-success btn-shadow">Editar</a>
