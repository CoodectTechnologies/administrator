        ...
        <div class="col-xl-4 col-6">
            ...
            <a href="#" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <!--end::Svg Icon-->
                    <div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5">{{ $this->orderTotalToday }}</div>
                    <div class="fw-bold text-gray-400">Este día</div>
                </div>
                <!--end::Body-->
            </a>
        ...
        <div class="col-xl-4 col-6">
            ...
            <a href="#" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <!--end::Svg Icon-->
                    <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">{{ $this->orderTotalMonth }}</div>
                    <div class="fw-bold text-gray-100">Este mes</div>
                </div>
                <!--end::Body-->
            </a>
            <!--end::Statistics Widget 5-->
        ...
        <div class="col-xl-4 col-6">
            ...
            <a href="#" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <!--end::Svg Icon-->
                    <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{ $this->orderTotal }}</div>
                    <div class="fw-bold text-white">Total ordenes</div>
                </div>
                <!--end::Body-->
            </a>
            <!--end::Statistics Widget 5-->
    ...
    <div class="row g-5 g-xl-8 pb-5">
        <div class="col-xl-4 col-6">
            ...
            <div class="card bg-success mb-xl-8">
                <!--begin::Body-->
                <div class="card-body">
                    <a class="card-title fw-bolder text-white fs-5 mb-3 d-block">Ordenes procesando</a>
                    <div class="py-1">
        ...
        <div class="col-xl-4 col-6">
            ...
            <div class="card bg-primary mb-xl-8">
                <!--begin::Body-->
                <div class="card-body">
                    <a class="card-title fw-bolder text-white fs-5 mb-3 d-block">Ordenes completadas</a>
                    <div class="py-1">
        ...
        <div class="col-xl-4 col-6">
            ...
            <div class="card bg-danger mb-xl-8">
                <!--begin::Body-->
                <div class="card-body">
                    <a class="card-title fw-bolder text-white fs-5 mb-3 d-block">Ordenes canceladas</a>
                    <div class="py-1">
    ...
    <div class="row g-5 g-xl-8 pb-5">
        <div class="col-xl-3 col-6">
            ...
            <div class="card bg-white mb-xl-8">
                <!--begin::Body-->
                <div class="card-body">
                    <a class="card-title fw-bolder text-black fs-5 mb-3 d-block">Productos publicados</a>
                    <div class="py-1">
        ...
        <div class="col-xl-3 col-6">
            ...
            <div class="card bg-white mb-xl-8">
                <!--begin::Body-->
                <div class="card-body">
                    <a class="card-title fw-bolder text-black fs-5 mb-3 d-block">Productos en borrador</a>
                    <div class="py-1">
        ...
        <div class="col-xl-3 col-6">
            ...
            <div class="card bg-white mb-xl-8">
                <!--begin::Body-->
                <div class="card-body">
                    <a class="card-title fw-bolder text-black fs-5 mb-3 d-block">Comentarios aprobados</a>
                    <div class="py-1">
        ...
        <div class="col-xl-3 col-6">
            ...
            <div class="card bg-white mb-xl-8">
                <!--begin::Body-->
                <div class="card-body">
                    <a class="card-title fw-bolder text-black fs-5 mb-3 d-block">Comentarios NO aprobados</a>
                    <div class="py-1">
        ...
        <div class="card card-flush overflow-hidden h-md-100">
            ...
            <div class="card-header py-5">
                ...
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder text-dark">Ventas {{ $year }}</span>
                    <span class="text-gray-400 mt-1 fw-bold fs-6">Gráfica de ventas</span>
                </h3>
                <!--end::Title-->
            </div>
            <!--end::Header-->
            ...
            <div class="card-body d-flex justify-content-between flex-column pb-1 px-0">
                ...
                <div class="px-9 mb-5">
                    ...
                    <div class="d-flex mb-2">
                        ...
                        <span class="fs-2hx fw-bolder text-gray-800 me-2 lh-1 ls-n2">{{ $this->orderTotalYear }}</span>
                    </div>
                    <!--end::Statistics-->
                </div>
                <!--end::Statistics-->
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <!--begin::Chart-->
                        <div class="" style="height: 300px;">
                            <livewire:livewire-pie-chart :pie-chart-model="$this->grapihSalesByStatus" />
                        </div>  
                        <!--end::Chart-->
                    </div>
                </div>
        ...
        <div class="col-xl-6 mb-5 mb-xl-10">
            ...
            <div class="card card-flush h-xl-100">
                ...
                <div class="card-header pt-7">
                    <!--begin::Title-->
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder text-dark">Ordenes procesando</span>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-3">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-100px">Creada</th>
                                    <th class="min-w-100px">Total</th>
                                    <th class="min-w-100px">Pago status</th>
                                </tr>
                                <!--end::Table row-->
                            </thead>
                            <!--end::Table head-->
        ...
        <div class="col-xl-6 mb-5 mb-xl-10">
            ...
            <div class="card card-flush h-xl-100">
                ...
                <div class="card-header pt-7">
                    <!--begin::Title-->
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder text-dark">Ordenes recientes</span>
                        <span class="text-gray-400 mt-1 fw-bold fs-6">Ultimas 10 ordenes</span>
                    </h3>
                    <!--end::Title-->
                </div>
                <!--end::Card header-->
        ...
        <div class="col-xl-4 mb-5 mb-xl-10">
            ...
            <div class="card card-flush h-xl-100">
                ...
                <div class="card-header pt-7">
                    <!--begin::Title-->
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder text-dark">Productos más vendidos</span>
                        ...
                        @foreach ($this->mostSelledProducts as $mostSelledProduct)
                            ...
                            <div class="rounded border-gray-300 border-1 border-gray-300 border-dashed px-7 py-3 mb-6">
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <!--end::Name-->
                                    <!--begin::Label-->
                                    <span class="badge badge-light-success">Ventas: {{ $mostSelledProduct->orders()->count() }}</span>
                                    <!--end::Label-->
                                </div>
                                <!--end::Customer-->
                            </div>
        ...
        <div class="col-xl-4 mb-5 mb-xl-10">
            ...
            <div class="card card-flush h-xl-100">
                ...
                <div class="card-header pt-7">
                    <!--begin::Title-->
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder text-dark">Productos más vistos</span>
                        <span class="text-gray-400 mt-1 fw-bold fs-6">Top 10</span>
                    </h3>
                    <!--end::Title-->
                </div>
                        ...
                        @foreach ($this->mostViewedProducts as $mostViewedProduct)
                            ...
                            <div class="rounded border-gray-300 border-1 border-gray-300 border-dashed px-7 py-3 mb-6">
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <!--end::Name-->
                                    <!--begin::Label-->
                                    <span class="badge badge-light-primary">Vistas: {{ $mostViewedProduct->viewUniques() }}</span>
                                    <!--end::Label-->
                                </div>
                                <!--end::Customer-->
                            </div>
        ...
        <div class="col-xl-4 mb-5 mb-xl-10">
            ...
            <div class="card card-flush h-xl-100">
                ...
                <div class="card-header pt-7">
                    <!--begin::Title-->
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder text-dark">Productos con stock bajo</span>
                        <span class="text-gray-400 mt-1 fw-bold fs-6">Stock menor o igual a 5</span>
                    </h3>
                    <!--end::Title-->
                </div>
                <!--end::Header-->
        ...
        <div class="col-xl-12 mb-5 mb-xl-10">
            ...
            <div class="card card-flush h-xl-100">
                ...
                <div class="card-header pt-7">
                    <!--begin::Title-->
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder text-dark">Comentarios no aprobados</span>
                    </h3>
                    <!--end::Title-->
                </div>
                <!--end::Card header-->
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-3">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-100px">Comentario</th>
                            ...
                            <tbody class="fw-bolder text-gray-600">
                                @foreach ($this->commentsNoApproved as $commentNoApproved)
                                    <tr>
                                        ...
                                        <td class=""><a href="{{ route('admin.catalog.product.edit', ['product' => $commentNoApproved->commentable, 'submodule' => 'comments']) }}">{{ $commentNoApproved->commentable->name }}</a></td>
                                    </tr>
                                @endforeach
                            </tbody>
                            <!--end::Table body-->
