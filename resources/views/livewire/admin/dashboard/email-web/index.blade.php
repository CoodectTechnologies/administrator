        ...
        <div class="col-xl-4 col-6">
            ...
            <a href="#" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <!--end::Svg Icon-->
                    <div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5">{{ $this->emailWebTotalToday }}</div>
        ...
        <div class="col-xl-4 col-6">
            ...
            <a href="#" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <!--end::Svg Icon-->
                    <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">{{ $this->emailWebTotalMonth }}</div>
        ...
        <div class="col-xl-4 col-6">
            ...
            <a href="#" class="card bg-primary hoverable card-xl-stretch mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <!--end::Svg Icon-->
                    <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{ $this->emailWebTotal }}</div>
                    <div class="fw-bold text-white">Total correos</div>
                </div>
                <!--end::Body-->
            </a>
            <!--end::Statistics Widget 5-->
    ...
    <div class="row g-5 g-xl-8 pb-5">
        <div class="col-xl-4 col-6">
            ...
            <div class="card bg-success mb-xl-8">
                <!--begin::Body-->
                <div class="card-body">
                    <a class="card-title fw-bolder text-white fs-5 mb-3 d-block">Conversiones (Si)</a>
                    <div class="py-1">
                        <span class="text-white fs-1 fw-bolder me-2">{{ count($emailWebsYes) }}</span>
                    </div>
                </div>
                <!--end:: Body-->
            </div>
        ...
        <div class="col-xl-4 col-6">
            ...
            <div class="card bg-danger mb-xl-8">
                <!--begin::Body-->
                <div class="card-body">
                    <a class="card-title fw-bolder text-white fs-5 mb-3 d-block">Conversiones (No)</a>
                    <div class="py-1">
                        <span class="text-white fs-1 fw-bolder me-2">{{ count($emailWebsNo) }}</span>
                    </div>
                </div>
                <!--end:: Body-->
            </div>
        ...
        <div class="col-xl-4 col-6">
            ...
            <div class="card bg-warning mb-xl-8">
                <!--begin::Body-->
                <div class="card-body">
                    <a class="card-title fw-bolder text-white fs-5 mb-3 d-block">Correos pendientes</a>
                    <div class="py-1">
                        <span class="text-white fs-1 fw-bolder me-2">{{ count($emailWebsWatting) }}</span>
                    </div>
                </div>
                <!--end:: Body-->
            </div>
        ...
        <div class="card card-flush overflow-hidden h-md-100">
            ...
            <div class="card-header py-5">
                ...
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder text-dark">Correos {{ $year }}</span>
                    <span class="text-gray-400 mt-1 fw-bold fs-6">Gráfica de correos</span>
                </h3>
                <!--end::Title-->
            </div>
            <!--end::Header-->
            ...
            <div class="card-body d-flex justify-content-between flex-column pb-1 px-0">
                ...
                <div class="px-9 mb-5">
                    ...
                    <div class="d-flex mb-2">
                        <span class="fs-4 fw-bold text-gray-400 me-1"><i class="fa fa-envelope"></i></span>
                        <span class="fs-2hx fw-bolder text-gray-800 me-2 lh-1 ls-n2">{{ $this->emailWebTotalYear }}</span>
                    </div>
                    <!--end::Statistics-->
                </div>
                <!--end::Statistics-->
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="" style="height: 300px;">
                            <livewire:livewire-line-chart :line-chart-model="$this->GrapihEmails" />
                        </div>  
                        <!--end::Chart-->
                    </div>
                    <div class="col-lg-6">
                        <!--begin::Chart-->
                        <div class="" style="height: 300px;">
                            <livewire:livewire-pie-chart :pie-chart-model="$this->GrapihEmailsByConversion" />
                        </div>  
                        <!--end::Chart-->
                    </div>
                </div>
