        ...
        <div class="card card-flush h-xl-100">
            ...
            <div class="card-header rounded bgi-no-repeat bgi-size-cover bgi-position-y-top bgi-position-x-center align-items-start h-250px" style="background-image:url('{{ asset('assets/admin/media/svg/shapes/top-green.png') }}')">
                ...
                <h3 class="card-title align-items-start flex-column text-white pt-15">
                    <span class="fw-bolder fs-2x mb-3">Hola {{ auth()->user()->name }}</span>
                    <div class="fs-4 text-white">
                        <span class="opacity-75">Resumen rapido</span>
                    </div>
                </h3>
                <!--end::Title-->
            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <!--end::Number-->
                                        <!--begin::Desc-->
                                        <span class="text-gray-500 fw-bold fs-6">Posts</span>
                                        <!--end::Desc-->
                                    </div>
                                    <!--end::Stats-->
                                </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <!--end::Number-->
                                        <!--begin::Desc-->
                                        <span class="text-gray-500 fw-bold fs-6">Ordenes</span>
                                        <!--end::Desc-->
                                    </div>
                                    <!--end::Stats-->
                                </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <!--end::Number-->
                                        <!--begin::Desc-->
                                        <span class="text-gray-500 fw-bold fs-6">Comentarios</span>
                                        <!--end::Desc-->
                                    </div>
                                    <!--end::Stats-->
                                </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <!--end::Number-->
                                        <!--begin::Desc-->
                                        <span class="text-gray-500 fw-bold fs-6">Correos web</span>
                                        <!--end::Desc-->
                                    </div>
                                    <!--end::Stats-->
                                </div>
                    ...
                    <div id="kt_sliders_widget_1_slider" class="card card-flush carousel carousel-custom carousel-stretch slide h-xl-100" data-bs-ride="carousel" data-bs-interval="5000">
                        ...
                        <div class="card-header pt-5">
                            ...
                            <h4 class="card-title d-flex align-items-start flex-column">
                                <span class="card-label fw-bolder text-gray-800">Ultimas 3 ordenes</span>
                            </h4>
                            <!--end::Title-->
                            <!--begin::Toolbar-->
                            ...
                            <div class="carousel-inner mt-n5">
                                @foreach ($this->orders as $order)
                                    ...
                                    <div class="carousel-item {{ $loop->iteration == 1 ? 'active show' : '' }}">
                                                ...
                                                <div class="d-flex d-grid gap-5">
                                                    ...
                                                    <div class="d-flex flex-column flex-shrink-0 me-4">
                                                        ...
                                                        <span class="d-flex align-items-center text-gray-400 fw-bolder fs-7">
                                                            ...
                                                            <!--end::Svg Icon--> Status: {{ $order->status  }}
                                                        </span>
                                                        <!--end::Section-->
                                                        <!--begin::Section-->
                                                        <span class="d-flex align-items-center text-gray-400 fw-bolder fs-7">
                                                            ...
                                                            <!--end::Svg Icon-->Pago status: {{ $order->payment_status }}
                                                        </span>
                                                        <!--end::Section-->
                                                        <!--begin::Section-->
                                                        <span class="d-flex align-items-center text-gray-400 fw-bolder fs-7">
                                                            ...
                                                            <!--end::Svg Icon-->Productos: {{ $order->products->sum('quantity') }}
                                                        </span>
                                                        <!--end::Section-->
                                                    </div>
                                                    <!--end::Item-->
                                        ...
                                        <!--begin::Action-->
                                        <div class="mb-1">
                                            <a href="{{ route('admin.order.index') }}" class="btn btn-sm btn-secondary">Ver todo</a>
                                            <a href="{{ route('admin.order.show', $order) }}" class="btn btn-sm btn-primary">Ver orden</a>
                                        </div>
                                        <!--end::Action-->
                                    </div>
                                    <!--end::Item-->
                ...
                <div class="col-xl-6 mb-5 mb-xl-10">
                    ...
                    <div id="kt_sliders_widget_2_slider" class="card card-flush carousel carousel-custom carousel-stretch slide h-xl-100" data-bs-ride="carousel" data-bs-interval="5500">
                        ...
                        <div class="card-header pt-5">
                            <!--begin::Title-->
                            <h4 class="card-title d-flex align-items-start flex-column">
                                <span class="card-label fw-bolder text-gray-800">Últimos 3 post</span>
                            </h4>
                            <!--end::Title-->
                            <!--begin::Toolbar-->
                            <div class="card-toolbar">
                            ...
                            <div class="carousel-inner">
                                @foreach ($this->blogPosts as $blogPost)
                                    ...
                                    <div class="carousel-item {{ $loop->iteration == 1 ? 'active show' : '' }}">
                                            ...
                                            <div class="m-0">
                                                ...
                                                <div class="d-flex d-grid gap-5">
                                                    ...
                                                    <div class="d-flex flex-column flex-shrink-0 me-4">
                                                        ...
                                                        <!--end::Svg Icon-->Vistas: {{ $blogPost->viewUniques() }}</span>
                                                        <!--end::Section-->
                                                        <!--begin::Section-->
                                                        <span class="d-flex align-items-center text-gray-400 fw-bolder fs-7">
                                                        <!--begin::Svg Icon | path: icons/duotune/general/gen057.svg-->
                                                        ...
                                                        <!--end::Svg Icon-->Comentaros: {{ $blogPost->comments->count() }}</span>
                                                        <!--end::Section-->
                                                    </div>
                                                    <!--end::Item-->
                                                </div>
                                        ...
                                        <!--begin::Action-->
                                        <div class="mb-1">
                                            <a href="{{ route('admin.blog.post.index') }}" class="btn btn-sm btn-secondary">Ver todo</a>
                                            <a href="{{ route('admin.blog.post.show', $blogPost) }}" class="btn btn-sm btn-success">Ver blog</a>
                                        </div>
                                        <!--end::Action-->
                                    </div>
                                    <!--end::Item-->
            ...
            <div class="card" style="background: #1C325E;">
                ...
                <div class="card-body d-flex ps-xl-15">
                    ...
                    <div class="m-0">
                        ...
                        <span class="me-2">Bienvenido al dashboard general,
                        <span class="position-relative d-inline-block text-danger">
                            <a class="text-danger opacity-75-hover">tienes otros 2 dashboard</a>
                            <!--begin::Separator-->
                            <span class="position-absolute opacity-50 bottom-0 start-0 border-4 border-danger border-bottom w-100"></span>
                            <!--end::Separator-->
                        </span></span>¿a donde te gustaría ir?.
                        <br /></div>
                        <!--end::Title-->
                        <!--begin::Action-->
                        <div class="mb-3">
                            <a href='{{ route('admin.dashboard.order.index') }}' class="btn btn-danger fw-bold me-2">Ordenes</a>
                            <a href="{{ route('admin.dashboard.blog.index') }}" class="btn btn-color-white bg-body bg-opacity-15 bg-hover-opacity-25 fw-bold">Blog</a>
                        </div>
                        <!--begin::Action-->
                    </div>
                    <!--begin::Action-->
            ...
            <div class="col-xl-4">
                ...
                <div class="card card-xl-stretch mb-xl-8">
                    ...
                    <div class="card-header border-0">
                        <h3 class="card-title fw-bolder text-dark">Actividad</h3>
                        <div class="card-toolbar">
                            <!--begin::Menu-->
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{ route('admin.user.show', ['user' => auth()->user(), 'submodule' => 'logs']) }}" class="menu-link px-3">Ver todo mi historial</a>
                                </div>
                                <!--end::Menu item-->
                            </div>
                            <!--end::Menu 3-->
                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-1">Ultimos correos web</span>
                            ...
                            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                ...
                                <thead>
                                    <tr class="fw-bolder text-muted">
                                        ...
                                        <th class="min-w-150px">Mensaje</th>
                                    </tr>
                                </thead>
                                <!--end::Table head-->
                                <!--begin::Table body-->
