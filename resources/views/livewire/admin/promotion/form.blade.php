    ...
    <form wire:submit.prevent="{{ $method }}" class="form d-flex flex-column flex-lg-row">
                ...
                <div class="card-body pt-0">
                    <div class="d-flex flex-column gap-10">
                        ...
                        <div class="fv-row">
                            ...
                            <!--end::Label-->
                            <input wire:model="promotion.name" required type="text" class="form-control mb-2 @error('promotion.name') 'invalid-feedback' @enderror" placeholder="Ej: Oferta a todos los productos"/>
                        ...
                        <div class="fv-row">
                            <!--begin::Label-->
                            <label class="form-label required">Porcentage descuento</label>
                            <!--end::Label-->
                            <input wire:model="promotion.percentage" required type="number" class="form-control mb-2 @error('promotion.percentage') 'invalid-feedback' @enderror" placeholder="Ej: 20"/>
                        ...
                        <div class="fv-row">
                            ...
                            <!--end::Label-->
                            <input wire:model="promotion.date_start" required type="date" class="form-control mb-2 @error('promotion.date_start') 'invalid-feedback' @enderror" placeholder=""/>
                        ...
                        <div class="fv-row">
                            ...
                            <!--end::Label-->
                            <input wire:model="promotion.date_end" required type="date" class="form-control mb-2 @error('promotion.date_end') 'invalid-feedback' @enderror" placeholder=""/>
                        ...
                        <div class="fv-row">
                            <!--begin::Label-->
                            <label class="form-label required">¿Aplica a las variantes de productos?</label>
                            <!--end::Label-->
        ...
        <div class="d-flex flex-column flex-lg-row-fluid gap-7 gap-lg-10">
                ...
                <div class="card-body pt-0">
                    <div class="d-flex flex-column gap-10">
                        ...
                        <div>
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="fv-row mb-5">
                                        ...
                                        <select wire:model="promotion.type" wire:change="changePromotionType()" required class="form-select mb-2">
                                            ...
                                            <option value="Categoría">Por categoría</option>
                                ...
                                <div class="col-lg-6">
                                    <div class="fv-row mb-5">
                                        <!--begin::Label-->
                                        <label class="required form-label">Condicional</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <select wire:model.defer="promotion.conditional" @if ($promotion->type && $promotion->type != 'Todos') required @endif class="form-select mb-2">
                                            @if ($promotion->type && $promotion->type != 'Todos')
                                                <option value="">Selecciona una opción</option>
                                                <option value="Que no sean">Que no sean</option>
                                                <option value="Que sean">Que sean</option>
                                            @else
                        ...
                        <div class="d-flex align-items-center position-relative mb-n7">
                            ...
                            <!--end::Svg Icon-->
                            <input wire:model="search" type="search" class="form-control form-control-solid w-100 w-lg-50 ps-14" placeholder="Buscar ..." />
                        </div>
                        <!--end::Search products-->
                        <!--begin::Table-->
                        <div class="overflow">
                            <table class="table align-middle table-row-dashed fs-6 gy-5 ">
                                ...
                                <thead>
                                    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                        <th class="w-25px pe-2">Selecciona</th>
                                    </tr>
                                </thead>
                                <!--end::Table head-->
                                <!--begin::Table body-->
            ...
            <div class="d-flex justify-content-end">
                <!--begin::Button-->
                <a href="{{ route('admin.promotion.index') }}" class="btn btn-light me-5">Cancelar</a>
                <!--end::Button-->
                <!--begin::Button-->
