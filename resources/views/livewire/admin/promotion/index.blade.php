    ...
    <div class="card">
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                <!--begin::Button-->
                <a href="{{ route('admin.promotion.create') }}" class="btn btn-light-primary">
                    ...
                    <tbody class="text-gray-600 fw-bold">
                        @foreach ($promotions as $promotion)
                            ...
                            <tr>
                                ...
                                <td class="">
                                    <!--begin::Update-->
                                    <a href="{{ route('admin.promotion.edit', $promotion) }}" class="btn btn-icon btn-active-light-success w-30px h-30px me-3">
