<div>
    ...
    <form class="form" wire:submit.prevent="{{ $method }}">
        ...
        <div class="fv-row mb-7">
            ...
            <input type="text" required wire:model.defer="partner.name" class="form-control form-control-solid @error('partner.name') 'invalid-feedback' @enderror" placeholder="Ej: Nombre del socio" name="" />
            @error('partner.name') <small  class="form-text text-danger" role="alert">{{ $message }}</small> @enderror
        </div>
        <!--end::Input group-->
        <!--begin::Actions-->
