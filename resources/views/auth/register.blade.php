    ...
    <div class="d-flex flex-column flex-lg-row-auto w-xl-600px positon-xl-relative" style="background-image: url('{{ asset('assets/admin/media/auth/sing_up.png') }}'); background-size: cover;">
        ...
        <div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
            ...
            <div class="d-flex flex-row-fluid flex-column text-center p-10 pt-lg-20">
                <!--begin::Logo-->
                <a href="{{ route('web.home.index') }}" class="py-9 mb-5">
            ...
            <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                ...
                <form class="form w-100" action="{{ route('register') }}" method="POST">
                    ...
                    <div class="fv-row mb-10">
                        <!--begin::Label-->
                        <label class="form-label fs-6 fw-bolder text-dark">Nombre completo</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                    ...
                    @if (Route::has('login.google'))
                        ...
                        <img alt="Registrate con Google" src="{{ asset('assets/admin/media/svg/brand-logos/google-icon.svg') }}" class="h-20px me-3" />Continua con Google
                        </a>
                        <!--end::Google link-->
                    @endif
                    <p class="pt-5"><a href="{{ route('login') }}" rel="noopener noreferrer">Regresar a iniciar sesión</a></p>
                </form>
                <!--end::Form-->
            </div>
            <!--end::Wrapper-->
