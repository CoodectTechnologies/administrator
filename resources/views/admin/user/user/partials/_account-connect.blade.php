    ...
    <form action="" wire:submit.prevent="syncConnectAcount">
        ...
        <div class="card-header border-0">
            <div class="card-title">
                <h3 class="fw-bolder m-0">Cuenta conectada</h3>
            </div>
        </div>
        <!--end::Card header-->
        <!--begin::Card body-->
        <div class="card-body pt-2">
            ...
            <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed mb-9 p-6">
                ...
                <div class="d-flex flex-stack flex-grow-1">
                    <!--begin::Content-->
                    <div class="fw-bold">
                        <div class="fs-6 text-gray-700">Al conectar la cuenta podrá iniciar sesión mediante la plataforma asociada.</div>
                    </div>
                    <!--end::Content-->
                </div>
                <!--end::Wrapper-->
                ...
                <div class="d-flex flex-stack">
                    <div class="d-flex">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="fs-6 fw-bold text-muted">Poder ingresar por este medio</div>
                        </div>
                    </div>
