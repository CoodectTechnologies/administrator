<!--begin::Delete-->
<button onclick="event.preventDefault(); confirmDestroyBanner({{ $banner->id }})" class="btn btn-icon btn-active-light-danger w-30px h-30px">
...
@once
    @push('footer')
    <script>
            function confirmDestroyBanner(id){
                swal.fire({
                    title: "¿Estás seguro?",
