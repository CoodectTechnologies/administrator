<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
    ...
    <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
        ...
        <ul class="menu menu-gray-600 menu-hover-primary fw-bold order-1">
            <li class="menu-item">
                <a href="https://coodect.com" target="_blank" class="menu-link px-2">Desarrollado por: Coodect Technologies</a>
            </li>
            <li class="menu-item">
                <a href="mailto:hola@coodect.com" target="_blank" class="menu-link px-2">Soporte</a>
            </li>
        </ul>
        <!--end::Menu-->
    </div>
