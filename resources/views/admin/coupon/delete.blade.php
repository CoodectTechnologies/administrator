<!--begin::Delete-->
<button onclick="event.preventDefault(); confirmDestroyCoupon({{ $coupon->id }})" class="btn btn-icon btn-active-light-danger w-30px h-30px">
...
@once
    @push('footer')
    <script>
        function confirmDestroyCoupon(id){
            swal.fire({
                title: "¿Estás seguro?",
                text: "No podrá recuperar este cupón.",
                icon: "warning",
