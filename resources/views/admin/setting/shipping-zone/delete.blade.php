<!--begin::Delete-->
<button onclick="event.preventDefault(); confirmDestroy({{ $shippingZone->id }})" class="btn btn-icon btn-active-light-danger w-30px h-30px">
    ...
    @push('footer')
        <script>
                function confirmDestroy(id){
                    swal.fire({
                        title: "¿Estás seguro?",
                        text: "No podrá recuperar esta zona de envío.",
                        icon: "warning",
