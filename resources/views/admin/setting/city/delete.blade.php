<!--begin::Delete-->
<button onclick="event.preventDefault(); confirmDestroyCity({{ $city->id }})" class="btn btn-icon btn-active-light-danger w-30px h-30px">
...
@once
    @push('footer')
        <script>
            function confirmDestroyCity(id){
                swal.fire({
                    title: "¿Estás seguro?",
                    text: "No podrá recuperar esta ciudad.",
                    icon: "warning",
