<!--begin::Delete-->
<button onclick="event.preventDefault(); confirmDestroy({{ $permission->id }})" class="btn btn-icon btn-active-light-danger w-30px h-30px">
    ...
    @push('footer')
        <script>
                function confirmDestroy(id){
                    swal.fire({
                        title: "¿Estás seguro?",
                        text: "No podrá recuperar este permiso.",
                        icon: "warning",
