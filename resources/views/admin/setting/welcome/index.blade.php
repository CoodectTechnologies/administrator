                ...
                <div class="card" style="background: #1C325E;">
                    ...
                    <div class="card-body d-flex ps-xl-15">
                        ...
                        <div class="m-0">
                            ...
                            <br>Conoce las distintas configuraciones que puedes realizar dentro del sistema</div>
                            <!--end::Title-->
                            <!--begin::Action-->
                            <div class="mb-3">
                                <a href="{{ route('admin.setting.permission') }}" class="btn btn-danger fw-bold me-2">Comenzar</a>
