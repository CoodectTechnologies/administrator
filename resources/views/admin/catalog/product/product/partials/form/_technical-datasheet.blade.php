 ...
 <div class="card card-flush py-4">
    ...
    <div class="card-body text-center pt-0">
        <div
            ...
            <div class="mt-1">
                ...
                <div class="image-input image-input-outline">
                    ...
                    @elseif (Storage::exists($product->technical_datasheet))
                        <div class="embed-responsive embed-responsive-16by9">
                    ...
                    <!--begin::Edit-->
                    <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow image-input" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Cambiar ficha técnica">
        ...
        <!--begin::Description-->
        <div class="text-muted fs-7">Establezca la ficha técnica. Solo se aceptan archivos .pdf</div>
        <!--end::Description-->
    </div>
    <!--end::Card body-->
</div>
