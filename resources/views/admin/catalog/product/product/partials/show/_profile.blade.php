            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center mb-2">
                    ...
                    @if ($product->status == 'Publicado')
                        <span class="btn btn-sm btn-primary fw-bolder ms-2 fs-8 py-1 px-3">Publicado</span>
                    @else
                        <span class="btn btn-sm btn-secondary fw-bolder ms-2 fs-8 py-1 px-3">Borrador</span>
                    @endif
                </div>
                <!--end::Name-->
                <!--begin::Info-->
                <div class="fw-bold fs-6 mb-4 pe-2">
                    <div class="fw-bold fs-5 text-gray-400">Ventas: {{ count($product->orders) }}</div>
                    <br>
                    <div class="fw-bold fs-5 text-gray-400">Vistas web: {{ $product->viewUniques() }}</div>
                </div>
                <!--end::Info-->
            </div>
            <!--end::User-->
            ...
            <div class="d-flex flex-column flex-grow-1 pe-8">
                ...
                <div class="d-flex flex-wrap">
                    ...
                    <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                        ...
                        <!--end::Number-->
                        <!--begin::Label-->
                        <div class="fw-bold fs-6 text-gray-400">Precio</div>
                        <!--end::Label-->
                    </div>
                    <!--end::Stat-->
