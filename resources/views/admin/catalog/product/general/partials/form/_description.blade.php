<div class="card card-flush py-4">
    ...
    <div class="card-body pt-0">
        ...
        <div wire:ignore wire:key="product.description">
            ...
            <!--end::Label-->
            <!--begin::Editor-->
            <textarea wire:model.defer="product.description" required cols="10" rows="5" class="form-control body @error('product.description') 'invalid-feedback' @enderror">{{ $product->body }}</textarea>
            <!--end::Editor-->
        </div>
        <!--end::Input group-->
