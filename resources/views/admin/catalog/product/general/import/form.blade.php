    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">Agregar archivo excel</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <form class="form" wire:submit.prevent="importProducts">
                    ...
                    <div class="mb-10 fv-row">
                        <label class="required form-label">Archivo excel</label>
                        <input wire:model.defer="excelImportTmp" id="{{ $fileTmpInputId }}" required type="file" class="form-control mb-2 @error('excelImportTmp') 'invalid-feedback' @enderror" placeholder="Archivo de excel"/>
