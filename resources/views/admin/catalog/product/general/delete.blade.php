<!--begin::Delete-->
<a onclick="event.preventDefault(); confirmDestroyCatalogProduct('{{ $product->slug }}')" class="btn btn-icon btn-active-light-danger w-30px h-30px">
...
@push('footer')
<script>
    function confirmDestroyCatalogProduct(slug){
        swal.fire({
            title: "¿Estás seguro?",
