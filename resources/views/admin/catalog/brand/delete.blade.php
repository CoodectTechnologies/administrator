<!--begin::Delete-->
<button onclick="event.preventDefault(); confirmDestroyCatalogBrand('{{ $brand->slug }}')" class="btn btn-icon btn-active-light-danger w-30px h-30px">
...
@once
    @push('footer')
    <script>
            function confirmDestroyCatalogBrand(slug){
                swal.fire({
                    title: "¿Estás seguro?",
                    text: "No podrá recuperar esta marca.",
                    icon: "warning",
