<!--begin::Delete-->
<button onclick="event.preventDefault(); confirmDestroyOrder({{ $order->id }})" class="btn btn-icon btn-active-light-danger w-30px h-30px">
...
@once
    @push('footer')
        <script>
                function confirmDestroyOrder(id){
                    swal.fire({
                        title: "¿Estás seguro?",
                        text: "No podrá recuperar esta orden.",
                        icon: "warning",
