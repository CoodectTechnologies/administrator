<!--begin::Delete-->
<button onclick="event.preventDefault(); confirmDestroyProject({{ $project->id }})" class="btn btn-icon btn-active-light-danger w-30px h-30px">
...
@once
    @push('footer')
    <script>
        function confirmDestroyProject(id){
            swal.fire({
                title: "¿Estás seguro?",
