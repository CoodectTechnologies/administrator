...
class Index extends Component
{
    ...
    public function getOrdersProperty(){
        return Order::with('products')->orderBy('id', 'desc')->take(3)->cursor();
    }
    public function getBlogPostsProperty(){
       return BlogPost::with(['comments',' blogCategories', 'blogTags'])->orderBy('id', 'desc')->take(3)->cursor();
    }
    public function getCommentsProperty(){
        return Comment::orderBy('id', 'desc')->take(10)->cursor();
    }
    public function getEmailsWebProperty(){
        return EmailWeb::orderBy('id', 'desc')->take(10)->cursor();
    }
