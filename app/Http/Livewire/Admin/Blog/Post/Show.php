...
class Show extends Component
{
    ...
    public function render(){
        $recentPosts = BlogPost::orderBy('id', 'desc')->take(5)->cursor();
        $comments = $this->post->comments()->orderBy('id', 'desc')->cursor();
        $lineChartModel = $this->graphViews();
        return view('livewire.admin.blog.post.show', compact('recentPosts', 'comments', 'lineChartModel'));
    }
